...
namespace YAGCI_SHIPPING
{
    ...
    public partial class ULabels : UserControl
    {
        ...
        private void metniDeğiştirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {               
                labelControl1.Text = frm.Baslik;
            }
        }

        private void metniDeğiştirToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Formlar.FormOzellikler frm =
           new Formlar.FormOzellikler() { Is = Formlar.FormOzellikler.Isler.BaslikDeistir };
